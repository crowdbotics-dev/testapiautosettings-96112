...
## Project Structure
    ...
    ├── testapiautosettings_96112  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_96112`
...
2. Clone this repo and `cd testapiautosettings_96112`
